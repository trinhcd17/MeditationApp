...
class PlayerView extends StatefulWidget {
  ...
  const PlayerView({Key key, @required this.title, @required this.description})
      : super(key: key);
  @override
          ...
          Padding(
            ...
            child: SliderTheme(
              data: SliderThemeData(
                ...
                activeTrackColor: kTextPrimaryColor,
    ...
    return Row(
      ...
      children: [
        InkWell(
          ...
          child: SvgPicture.asset('assets/icons/previous_15s.svg'),
        ),
        InkWell(
          onTap: () {
          ...
          child: Container(
            ...
            child: Container(
              ...
              width: 80,
              decoration: BoxDecoration(
                  color: kTextPrimaryColor, shape: BoxShape.circle),
              child: Obx(
                () => Icon(
        ...
        InkWell(
          ...
          child: SvgPicture.asset('assets/icons/next_15s.svg'),
        ),
      ],
    );
  }
